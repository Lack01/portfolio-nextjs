...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      id="experience"
      className="w-full border-white/[0.1] bg-black-100 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="heading pb-10">
          Registros de mi {''}
          <span className="text-cyan">Trayecto</span>
        </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-20 items-center top-50 self-start max-w-xs lg:max-w-sm md:w-full">
