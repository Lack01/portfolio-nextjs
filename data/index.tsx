...
export const navItems = [
    ...
    { name: "Mi trayecto", link: "#experience" },
  ...
  export const gridItems = [
    ...
    {
      id: 2,
      title: "Soy muy flexible con las reubicaciones.",
      description: "",
    ...
    },
    {
      ...
      description: "Trato de mejorar constantemente",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
    ...
    {
      id: 5,
      title: "Actualmente desarrollando un Blog automatizado por IA",
